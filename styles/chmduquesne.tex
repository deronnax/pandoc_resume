...
\definecolor[bitecolor][h=000000]
...
\setuphead[subsubsection][style=\bf, color=bitecolor]
...
\definedescription
  ...
  [headstyle=bold, style=normal,
   location=hanging, width=18mm, distance=12mm, margin=0cm]
